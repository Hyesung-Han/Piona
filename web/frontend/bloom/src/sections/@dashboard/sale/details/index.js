        ...
        <Grid container>
          ...
          <Grid item xs={12} sm={6} sx={{ mb: 5 }}>
            <Box sx={{ textAlign: { sm: 'right' } }}>
              ...
              <Typography variant="h6">{`INV-${SaleNumber}`}</Typography>
            </Box>
          </Grid>
          ...
          <Grid item xs={12} sm={6} sx={{ mb: 5 }}>
            ...
            <Typography variant="body2">{SaleFrom.name}</Typography>
            <Typography variant="body2">{SaleFrom.address}</Typography>
            <Typography variant="body2">Phone: {SaleFrom.phone}</Typography>
          </Grid>
          ...
          <Grid item xs={12} sm={6} sx={{ mb: 5 }}>
            ...
            <Typography variant="body2">{SaleTo.name}</Typography>
            <Typography variant="body2">{SaleTo.address}</Typography>
            <Typography variant="body2">Phone: {SaleTo.phone}</Typography>
          </Grid>
