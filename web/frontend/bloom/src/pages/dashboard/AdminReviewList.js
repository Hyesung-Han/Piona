...
const TABLE_HEAD = [
  { id: 'shop_name', label: '가게명', align: 'left' },
  { id: 'nickname', label: '닉네임', align: 'left' },
  { id: 'content', label: '리뷰', align: 'center' },
  { id: 'comment', label: '답변 여부', align: 'center'},
  { id: 'status', label: '신고 상태', align: 'center' },
  { id: '' },
];
                ...
                <TableBody>
                  ...
                  {dataFiltered.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => (
                      <ReviewTableRow
                        ...
                        onCancelBan={() => handleCancelBan(row.review_id)}
                        onDeleteReview={() => handleDeleteReview(row.review_id)}
