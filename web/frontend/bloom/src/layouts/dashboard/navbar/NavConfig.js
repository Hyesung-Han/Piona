...
const navConfig = [
  ...
  // ----------------------------------------------------------------------
  {
    ...
    items: [
      ...
      { title: '예약 관리', path: PATH_DASHBOARD.reservation.list, icon: ICONS.dashboard },
      { title: '정산 관리', path: PATH_DASHBOARD.sale.list, icon: ICONS.analytics },
      { title: '리뷰 관리', path: PATH_DASHBOARD.review.list, icon: ICONS.banking },
